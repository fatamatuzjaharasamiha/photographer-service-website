        ...
        <div className='w-75 mx-auto mt-5 shadow-lg p-5 bg-body rounded'>
            <Accordion> <h1 className='pb-4'>Question and Answer</h1>
                ...
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body><span className='fw-bold'>Answer :</span> Firebase Authentication provides backend services, easy-to-use SDKs, and ready-made UI libraries to authenticate users to app. It supports authentication using passwords, phone numbers, popular federated identity providers like Google, Facebook and Twitter, and more.
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body><span className='fw-bold'>Answer :</span>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
        </div>
